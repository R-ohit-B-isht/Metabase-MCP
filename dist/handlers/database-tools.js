...
export class DatabaseToolHandlers {
    ...
    async getDatabase(args) {
        ...
        if (args.include_editable_data_model)
            params.append('include_editable_data_model', args.include_editable_data_model.toString());
        if (args.exclude_uneditable_details)
            params.append('exclude_uneditable_details', args.exclude_uneditable_details.toString());
    ...
    async getDatabaseAutocompleteSuggestions(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async discardDatabaseFieldValues(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async dismissDatabaseSpinner(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getDatabaseHealthcheck(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getDatabaseIdFields(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getDatabaseMetadata(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async rescanDatabaseFieldValues(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getDatabaseSchemaTablesForSchema(args) {
    ...
    async getDatabaseSyncableSchemas(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getDatabaseUsageInfo(args) {
        const { id } = args;
        if (!id) {
            throw new McpError(ErrorCode.InvalidParams, "Database ID is required");
        }
    ...
    async getVirtualDatabaseDatasets(args) {
    ...
    async getVirtualDatabaseDatasetsForSchema(args) {
    ...
    async getVirtualDatabaseMetadata(args) {
        const { virtual_db } = args;
        if (!virtual_db) {
            throw new McpError(ErrorCode.InvalidParams, "Virtual database identifier is required");
        }
    ...
    async getVirtualDatabaseSchemaTables(args) {
        const { virtual_db, schema } = args;
        if (!virtual_db || !schema) {
            throw new McpError(ErrorCode.InvalidParams, "Virtual database identifier and schema are required");
        }
    ...
    async getVirtualDatabaseSchemas(args) {
        const { virtual_db } = args;
        if (!virtual_db) {
            throw new McpError(ErrorCode.InvalidParams, "Virtual database identifier is required");
        }
